...
class component extends Component {
  ...
  render() {
    ...
    const createAccountButton = (
      <Touchable onPress={this.createAccountHandler}>
        <Account style={styles.imgAccount} />
        <Text style={styles.text}>Criar conta</Text>
      </Touchable>
    );

    const changePasswordButton = (
      <Touchable onPress={this.passwordRecoveryHandler}>
        <LockReset style={styles.imgChangePassword} />
